// SQLite compile flags tuned for Syncular's browser runtime:
//
// - keep the base WASM/runtime flags from upstream sqlite-wasm-rs;
// - keep FTS5 for normal offline-first full-text search use cases;
// - omit optional extension/debug/introspection flags that Syncular does not
//   promise through the browser SQL surface.
const FULL_FEATURED: [&str; 10] = [
    "-DSQLITE_OS_OTHER",
    "-DSQLITE_USE_URI",
