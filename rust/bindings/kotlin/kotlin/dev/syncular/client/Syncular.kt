...
class SyncularBoltClient private constructor(internal val handle: Long) : AutoCloseable {
    ...
    @Throws(FfiException::class)
    fun forceSubscriptionsBootstrapJson(subscriptionIdsJson: String): String {
        val buf = Native.boltffi_syncular_bolt_client_force_subscriptions_bootstrap_json(handle, subscriptionIdsJson.toByteArray(Charsets.UTF_8))
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    @Throws(FfiException::class)
    fun resetLocalSyncStateJson(requestJson: String): String {
        val buf = Native.boltffi_syncular_bolt_client_reset_local_sync_state_json(handle, requestJson.toByteArray(Charsets.UTF_8))
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    @Throws(FfiException::class)
    fun appSchemaStateJson(): String {
        val buf = Native.boltffi_syncular_bolt_client_app_schema_state_json(handle)
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    fun diagnosticSnapshotJson(): String {
        val buf = Native.boltffi_syncular_bolt_client_diagnostic_snapshot_json(handle)
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    @Throws(FfiException::class)
    fun localHealthCheckJson(): String {
        val buf = Native.boltffi_syncular_bolt_client_local_health_check_json(handle)
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    @Throws(FfiException::class)
    fun exportLocalSupportBundleJson(): String {
        val buf = Native.boltffi_syncular_bolt_client_export_local_support_bundle_json(handle)
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    @Throws(FfiException::class)
    fun importLocalSupportBundleJson(bundleJson: String): String {
        val buf = Native.boltffi_syncular_bolt_client_import_local_support_bundle_json(handle, bundleJson.toByteArray(Charsets.UTF_8))
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
    ...
    fun issueAuthLeaseJson(requestJson: String): String {
        val buf = Native.boltffi_syncular_bolt_client_issue_auth_lease_json(handle, requestJson.toByteArray(Charsets.UTF_8))
            ?: throw FfiException(-1, "Null buffer returned")
        val reader = WireReader(buf)
        return reader.readResult({ reader.readString() }, { reader.readString() }).getOrThrow()
    }
...
private object Native {
    ...
    @JvmStatic external fun boltffi_syncular_bolt_client_force_subscriptions_bootstrap_json(handle: Long, subscription_ids_json: ByteArray): ByteArray?
    @JvmStatic external fun boltffi_syncular_bolt_client_reset_local_sync_state_json(handle: Long, request_json: ByteArray): ByteArray?
    ...
    @JvmStatic external fun boltffi_syncular_bolt_client_app_schema_state_json(handle: Long): ByteArray?
    ...
    @JvmStatic external fun boltffi_syncular_bolt_client_export_local_support_bundle_json(handle: Long): ByteArray?
    ...
    @JvmStatic external fun boltffi_syncular_bolt_client_issue_auth_lease_json(handle: Long, request_json: ByteArray): ByteArray?
