...
public final class SyncularBoltClient implements AutoCloseable {
    ...
    public String resetLocalSyncStateJson(String requestJson) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_reset_local_sync_state_json(handle, requestJson.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String resumeFromBackground() {
        byte[] _buf = Native.boltffi_syncular_bolt_client_resume_from_background(handle);
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public boolean joinPresence(String scopeKey, java.util.Optional<String> metadataJson) {
        try (
            WireWriter _wire_metadata_json = new WireWriter((1 + ((metadataJson).isPresent() ? ((4 + (4 + ((metadataJson).get()).length() * 3))) : 0)))
        ) {
            if ((metadataJson).isPresent()) { _wire_metadata_json.writeI8((byte)1); _wire_metadata_json.writeString((metadataJson).get()); } else { _wire_metadata_json.writeI8((byte)0); };
            byte[] _buf = Native.boltffi_syncular_bolt_client_join_presence(handle, scopeKey.getBytes(java.nio.charset.StandardCharsets.UTF_8), _wire_metadata_json.toBuffer());
            if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
            WireReader reader = new WireReader(_buf);
            if (reader.readI8() != 0) {
                throw new RuntimeException(reader.readString());
    ...
    public boolean leavePresence(String scopeKey) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_leave_presence(handle, scopeKey.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public boolean updatePresenceMetadata(String scopeKey, String metadataJson) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_update_presence_metadata(handle, scopeKey.getBytes(java.nio.charset.StandardCharsets.UTF_8), metadataJson.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String presenceJson(String scopeKey) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_presence_json(handle, scopeKey.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String appSchemaStateJson() {
        byte[] _buf = Native.boltffi_syncular_bolt_client_app_schema_state_json(handle);
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String localHealthCheckJson() {
        byte[] _buf = Native.boltffi_syncular_bolt_client_local_health_check_json(handle);
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String exportLocalSupportBundleJson() {
        byte[] _buf = Native.boltffi_syncular_bolt_client_export_local_support_bundle_json(handle);
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String importLocalSupportBundleJson(String bundleJson) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_import_local_support_bundle_json(handle, bundleJson.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String repairLocalHealthJson(String requestJson) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_repair_local_health_json(handle, requestJson.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
    ...
    public String issueAuthLeaseJson(String requestJson) {
        byte[] _buf = Native.boltffi_syncular_bolt_client_issue_auth_lease_json(handle, requestJson.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        if (_buf == null) throw new RuntimeException("FFI call returned null buffer");
        WireReader reader = new WireReader(_buf);
        if (reader.readI8() != 0) {
            throw new RuntimeException(reader.readString());
