...
- Starter/browser-deploy changes:
  ...
  activation, CDP off-the-record memory-storage development-policy
  classification, CDP off-the-record default-storage restart
  non-persistence, and live support-bundle failure artifact validation.
