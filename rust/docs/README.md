...
- [`implementation history`](implementation history): current status, priority queue, and active work
...
the execution order, update `implementation history` and the affected work package in the
same commit.
