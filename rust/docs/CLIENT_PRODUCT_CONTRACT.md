...
| Blobs | Native blob upload/reference sync/retrieval, cache pruning APIs, browser/native blob upload lifecycle stats | Queued blob worker coverage and conformance expansion | Blob refs participate in auth, retry, sync, and encryption semantics |
