...
- Reference docs contain historical planning material. Archive or prune only
  when the current implementation plan and product contract no longer need the history.
...
- Created WP-30 and made it the active cleanup track in the implementation plan.
...
- Gates:
  - `bunx biome check packages/server-hono/src/console/routes.ts rust/docs/COMPATIBILITY_REGISTER.md rust/docs/work-packages/WP-30-foundation-cleanup-complexity.md rust/docs/implementation history`: passed for the checked TypeScript file; Markdown paths are ignored by Biome in this repo.
  - `bun --cwd packages/server-hono tsgo`: passed.
...
- Gates:
  - `bunx biome check tests/unit/external-chunk-storage-integration.test.ts rust/docs/COMPATIBILITY_REGISTER.md rust/docs/work-packages/WP-30-foundation-cleanup-complexity.md rust/docs/implementation history`: passed for the checked TypeScript file; Markdown paths are ignored by Biome in this repo.
...
- Browser root export cleanup gates:
  - `bunx biome check packages/client/src/index.ts packages/client/src/public-api.test.ts rust/docs/COMPATIBILITY_REGISTER.md rust/docs/implementation history`:
    passed.
  - `bun --cwd packages/client tsgo`: passed.
