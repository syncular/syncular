...
The implementation plan already has verified roots, scoped revocation clearing, artifacts,
...
WP-20 is complete for the current foundation. Move to the next implementation plan item.
