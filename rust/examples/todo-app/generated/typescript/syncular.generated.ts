...
import { SYNCULAR_PACKAGE_NAME, SYNCULAR_PACKAGE_VERSION, SYNCULAR_WORKER_PROTOCOL_VERSION, createSyncularCommandHistory, createSyncularDatabase, getSyncularRuntimeArtifact, selectSyncularRuntimeArtifact, withSyncularSchemaWrites } from '../../../../../packages/client/src';
import { getSyncularSubscriptionReadiness } from '../../../../../packages/client/src/subscription-readiness';
...
import type { SyncularSubscriptionReadinessOptions, SyncularSubscriptionReadinessResult } from '../../../../../packages/client/src/subscription-readiness';
...
export type SyncularAppDatabase = Omit<SyncularDatabase<SyncularAppDb>, 'mutations' | 'leasedMutations' | 'schemaReadiness'> & {
  ...
  commentSubscriptionReadiness(options?: Omit<SyncularSubscriptionReadinessOptions, 'expectedSubscriptions' | 'tables'>): Promise<SyncularSubscriptionReadinessResult>;
  ...
  projectSubscriptionReadiness(options?: Omit<SyncularSubscriptionReadinessOptions, 'expectedSubscriptions' | 'tables'>): Promise<SyncularSubscriptionReadinessResult>;
...
export async function createSyncularAppDatabase(
  ...
  try {
    ...
    appDatabase.commentSubscriptionReadiness = (readinessOptions) => getSyncularSubscriptionReadiness(subscriptionReadinessClient, { ...readinessOptions, expectedSubscriptions: syncularAppSubscriptions.filter((subscription) => subscription.table === 'comments'), tables: ['comments'] });
    ...
    appDatabase.projectSubscriptionReadiness = (readinessOptions) => getSyncularSubscriptionReadiness(subscriptionReadinessClient, { ...readinessOptions, expectedSubscriptions: syncularAppSubscriptions.filter((subscription) => subscription.table === 'projects'), tables: ['projects'] });
