/**
 * The quickstart, end to end, in the normal `bun test` sweep — so the docs'
 * ≤5-minute path can never rot. Boots the real Hono server on an ephemeral
 * port and drives two independent bun:sqlite client cores through it over
 * real HTTP, asserting they converge.
 */
