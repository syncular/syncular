...
[`SPEC.md`](https://github.com/syncular/syncular/blob/main/SPEC.md); parity is proven by a
...
[implementation history](https://github.com/syncular/syncular/blob/main/implementation history) sets three rules for the tree:
