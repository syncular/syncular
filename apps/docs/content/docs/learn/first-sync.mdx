...
Most apps should not customize client apply behavior. Model soft delete,
stale marking, and derived projections in generated table metadata or local
read models so the runtime can keep outbox, conflicts, CRDT fields, and live
events coherent.
...
- [Architecture](/docs/learn/architecture) - Deep dive into the commit log
- [Scopes](/docs/learn/scopes) - Understand authorization
- [Conflict Resolution](/docs/learn/conflict-resolution) - Handle conflicts
