...
For a deeper dive, see [Scopes](/learn/scopes).
...
- [Architecture](/learn/architecture) -- How commits fit into the sync system
- [Scopes](/learn/scopes) -- Authorization and data partitioning
- [Conflict Resolution](/learn/conflict-resolution) -- What happens when two clients edit the same row
- [Glossary](/learn/glossary) -- Definitions of key terms
