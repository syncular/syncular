...
When a client pulls data, the server computes **effective scopes** as the intersection of what the client requested (via its [subscription](/docs/learn/subscriptions)) and what `resolveScopes` allows:
...
- [Subscriptions](/docs/learn/subscriptions) -- How clients request data using scopes
- [Authorization Guide](/docs/learn/scopes) -- Implementing auth patterns
- [Data Modeling with Scopes](/docs/features/data-modeling) -- Practical schema + scope design
