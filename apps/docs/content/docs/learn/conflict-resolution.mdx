...
- [Commits](/docs/learn/commits) -- How the commit log works
- [Glossary](/docs/learn/glossary) -- Key terms (Conflict, Outbox, Scope)
- [Table Handlers](/docs/server/table-handlers) -- Implement server-side conflict detection
