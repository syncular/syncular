...
<Cards>
  <Card title="Evaluate Syncular" href="/docs/introduction" description="Fit, demo, trust signals, and honest comparisons before you commit" />
  <Card title="Implement the Core Path" href="/docs/build" description="Server setup, client setup, table handlers, and the first production-ready build path" />
...
<Cards>
  <Card title="Testing & Confidence" href="/docs/introduction/testing-and-confidence" description="How the test suite is layered, what gets exercised, and how to evaluate risk" />
  ...
  <Card title="Audit & History" href="/docs/build/audit-ui" description="Product-facing history, app-owned audit logs, and links into operator forensics" />
...
<Cards>
  ...
  <Card title="Rust Client" href="/docs/rust-client" description="Rust-first client, browser Worker, native bindings, testkit, and packaging" />
...
See [Good Fit & Not Fit](/docs/introduction/good-fit) for a fuller decision guide, including multiplayer games and other workloads that want a different architecture.
