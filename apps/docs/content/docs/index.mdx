...
subscriptions: [
  { id: 'my-tasks', shape: 'tasks', scopes: { project_id: '456' } }
]
...
- Want arbitrary client queries without server-defined shapes (consider [Zero](/docs/introduction/comparison/vs-zero))
