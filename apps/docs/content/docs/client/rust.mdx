...
Use [Native lifecycle](/docs/client/native) when a Rust app wants the UI worker,
event stream, queued commands, presence handles, and realtime lifecycle used by
Swift/Kotlin/JVM hosts.
