...
For UI/operator workflows, see the dedicated [Console docs](/docs/operate/console). This page focuses on route setup and endpoint behavior.
For integration options (CLI serve, mount API, components), see [Console Integration](/docs/operate/console-integration).
...
```bash
# Daily: Prune old console events immediately (manual trigger)
...
- [Testing Guide](/docs/testing) - Test your sync setup
- [Architecture](/docs/learn/architecture) - System design overview
