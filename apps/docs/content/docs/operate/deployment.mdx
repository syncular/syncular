...
- A working Syncular server setup ([Server Getting Started](/server/getting-started))
...
Syncular works on Cloudflare Workers with some considerations. See the [Cloudflare Adapter](/reference/server/cloudflare-adapter) page for the full adapter setup.
...
- [Server Getting Started](/server/getting-started) - Configure sync routes and handlers
- [Performance & Scaling](/operate/performance) - Optimize for large datasets
