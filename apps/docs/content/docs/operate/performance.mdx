...
- A working Syncular setup ([Server Setup](/docs/server/setup-with-hono), [Client Setup](/docs/client/quick-start))
...
the generator can carry the same schema contract to browser, Rust, Swift, and
Kotlin bindings:
