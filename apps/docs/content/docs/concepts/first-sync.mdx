...
> **Deep dive.** For the canonical “How sync works” overview, start with [Architecture](/docs/concepts/architecture).
...
- [Architecture](/docs/concepts/architecture) — canonical deep dive into the sync lifecycle
- [Blob Storage](/docs/build/recipes/blobs-and-media) — snapshot chunks use the same storage adapter system
- [Performance](/docs/operate/performance) — bootstrap tuning and large dataset strategy
- [Table Handlers](/docs/reference/server/table-handlers-reference) — controlling snapshot/apply and auth boundaries

## Next Steps

- [Architecture](/docs/concepts/architecture) - Deep dive into the commit log
- [Scopes](/docs/concepts/scopes) - Understand authorization
- [Conflict Resolution](/docs/concepts/conflict-resolution) - Handle conflicts
