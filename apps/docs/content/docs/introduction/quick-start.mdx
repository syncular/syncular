...
> Prefer scaffolding a new project? See the [CLI docs](/docs/cli) and run `syncular create demo --dir ./my-syncular-demo` (or `npx @syncular/cli create demo --dir ./my-syncular-demo`).
