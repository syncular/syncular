...
```typescript
// Bob's subscription
{ id: 'project-alpha-tasks', shape: 'tasks', scopes: { project_id: 'alpha' } }
...
- [Authorization Guide](/docs/guides/auth) -- Implementing auth patterns
- [Data Modeling with Scopes](/docs/guides/data-modeling) -- Practical schema + scope design
