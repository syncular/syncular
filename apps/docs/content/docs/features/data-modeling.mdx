...
- Familiarity with [Scopes](/learn/scopes) and [Table Handlers](/server/table-handlers)
...
The [Testing](/testing) guide shows end-to-end patterns.

## Next steps

- [Scopes](/learn/scopes) — How scopes work
- [Authorization](/server/scopes-and-auth) — Implementing `resolveScopes` patterns
- [Subscriptions](/learn/subscriptions) — Client subscriptions and lifecycle
