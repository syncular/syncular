...
This guide helps you choose scope boundaries and row shapes that stay understandable under load, offline churn, and changing permissions.

## Use this page when

- you are deciding which columns should become scope keys
- you are shaping a multi-tenant, project-based, or user-owned schema
- you want to avoid high-cardinality or volatile scope designs that become hard to operate
...
- Familiarity with [Scopes](/docs/learn/scopes) and [Table Handlers](/docs/server/table-handlers)
...
## Server handler example: project membership
...
Client subscriptions are now predictable across bindings:
...
## Server handler example: per-user private data
...
The [Testing](/docs/testing) guide shows end-to-end patterns.

## Next steps

- [Scopes](/docs/learn/scopes) — How scopes work
- [Authorization](/docs/learn/scopes) — Implementing `resolveScopes` patterns
- [Subscriptions](/docs/learn/subscriptions) — Client subscriptions and lifecycle
