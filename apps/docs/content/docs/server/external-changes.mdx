...
- Familiarity with [Server Getting Started](/server/getting-started) and [Table Handlers](/server/table-handlers)
...
- [Server Getting Started](/server/getting-started) -- Configure the sync server
- [Table Handlers](/server/table-handlers) -- Define sync behavior per table
- [Realtime](/server/realtime-websocket) -- Push updates to clients immediately
