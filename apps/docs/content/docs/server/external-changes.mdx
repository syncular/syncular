...
- Familiarity with [Server Setup](/docs/server/setup-with-hono) and [Table Handlers](/docs/server/table-handlers)
...
- [Table Handlers](/docs/server/table-handlers) -- Define sync behavior per table
- [Realtime](/docs/server/realtime-websocket) -- Push updates to clients immediately
