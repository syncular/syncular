...
- Familiarity with [Server Setup](/docs/server/setup-with-hono) and [Table Handlers](/docs/reference/server/table-handlers-reference)
...
- [Server Setup](/docs/server/setup-with-hono) -- Configure the sync server
- [Table Handlers](/docs/reference/server/table-handlers-reference) -- Define sync behavior per table
- [Realtime](/docs/reference/server/realtime-bridge) -- Push updates to clients immediately
