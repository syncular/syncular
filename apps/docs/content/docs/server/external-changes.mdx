...
- Familiarity with [Server Setup](/server/setup-with-hono) and [Table Handlers](/server/table-handlers)
...
- [Server Setup](/server/setup-with-hono) -- Configure the sync server
