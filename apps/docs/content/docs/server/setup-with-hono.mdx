...
See [Table Handlers](/docs/reference/server/table-handlers-reference) for advanced patterns and [Auth](/docs/learn/scopes) for authorization strategies.
...
- [Client Setup](/docs/client/quick-start) — set up the React client
- [Table Handlers](/docs/reference/server/table-handlers-reference) — deep dive into handlers
- [Auth](/docs/learn/scopes) — authorization patterns
