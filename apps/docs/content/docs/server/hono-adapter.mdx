...
These endpoints are **relative to where you mount** `createSyncRoutes`. If you mount at `/sync`, the pull endpoint is `POST /sync/pull`.
...
| `INVALID_SUBSCRIPTION` | 400 | Unknown shape |
