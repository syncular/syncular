...
- SQL-first app model with a Rust-owned client runtime, Kysely for TypeScript
  reads, Diesel for Rust reads, and Kysely server handlers
...
- [Syncular vs Electric SQL](/docs/start/comparison/vs-electric)
- [Syncular vs Zero](/docs/start/comparison/vs-zero)
- [Syncular vs Jazz](/docs/start/comparison/vs-jazz)
- [Syncular vs PowerSync](/docs/start/comparison/vs-powersync)
- [Others](/docs/start/comparison/others)
