...
- [Schema Migrations](/docs/build/migrations) for migration strategy and schema evolution
- [CLI Overview](/docs/build/cli) for the rest of the command surface
- [Server Setup](/docs/build/server-setup) for the canonical database bring-up path
