...
- Familiarity with [Scopes](/docs/concepts/scopes) and [Table Handlers](/docs/reference/server/table-handlers-reference)
...
- [Scopes](/docs/concepts/scopes) — How scopes work
- [Authorization](/docs/concepts/scopes) — Implementing `resolveScopes` patterns
- [Subscriptions](/docs/concepts/subscriptions) — Client subscriptions and lifecycle
