...
<Mermaid
  chart={`
flowchart LR
  Request["Requested scope<br/>project A"] --> Resolve["Allowed scopes<br/>projects A and B"]
  Resolve --> Effective["Effective scope<br/>project A"]
  Effective --> Result["Pull returns<br/>project A rows only"]
`}
