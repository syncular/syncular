...
If your server intentionally omits private ownership columns from rows it sends
to clients, keep the local column and let the default handler populate it from
the subscription/change scopes:
