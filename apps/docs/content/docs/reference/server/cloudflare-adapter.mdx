...
- [Hono Adapter](/docs/reference/server/hono-adapter) - Hono route configuration
- [Dialects](/docs/reference/server/dialects) - Database dialect options
- [Realtime](/docs/reference/server/realtime-bridge) - Client-side realtime setup
