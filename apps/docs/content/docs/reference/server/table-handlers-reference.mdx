...
- **Apply row writes**: Insert or update with automatic `server_version` increment, constraint error classification, and version conflict detection
...
- [Table Handlers Guide](/docs/server/table-handlers) -- Patterns and authorization
- [Subscription Registry](/docs/reference/server/subscription-registry) -- Configure scopes
