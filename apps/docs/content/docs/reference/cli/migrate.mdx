...
- [Schema Migrations](/docs/features/migrations) for migration strategy and schema evolution
- [CLI Overview](/docs/reference/cli) for the rest of the command surface
- [Server Setup](/docs/server/setup-with-hono) for the canonical database bring-up path
