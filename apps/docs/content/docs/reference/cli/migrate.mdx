...
- [Schema Migrations](/features/migrations) for migration strategy and schema evolution
- [CLI Overview](/reference/cli) for the rest of the command surface
- [Server Getting Started](/server/getting-started) for the canonical database bring-up path
