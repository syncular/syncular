...
- A working Syncular server setup ([Server Setup](/docs/guides/server-setup))
...
Syncular works on Cloudflare Workers with some considerations. See the [Cloudflare Adapter](/docs/sdk/server/cloudflare-adapter) page for the full adapter setup.
...
- [Server Setup](/docs/guides/server-setup) - Configure sync routes and handlers
