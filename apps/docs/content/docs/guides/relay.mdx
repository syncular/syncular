...
const mainServerTransport = createHttpTransport({
  // baseUrl is the prefix *before* `/sync/*` (e.g. https://api.example.com → https://api.example.com/sync/pull)
...
- [Server Setup](/docs/guides/server-setup) - Main server configuration
- [Realtime Guide](/docs/guides/realtime) - WebSocket for instant updates
