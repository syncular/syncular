...
```
  1. Client subscribes:  { shape: 'tasks', scopes: { user_id: '123' } }
...
See [Table Handlers](/docs/guides/table-handlers) for advanced patterns and [Auth](/docs/guides/auth) for authorization strategies.
...
See [Real-time Guide](/docs/guides/realtime) for multi-instance broadcasting and client setup.
...
See [Operations Guide](/docs/guides/operations) for console API details.
...
- [Client Setup](/docs/guides/client-setup) — set up the React client
- [Table Handlers](/docs/guides/table-handlers) — deep dive into handlers
- [Auth](/docs/guides/auth) — authorization patterns
