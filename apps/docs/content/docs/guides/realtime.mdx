...
- A working [Server Setup](/docs/guides/server-setup) and [Client Setup](/docs/guides/client-setup)
...
> **Browser note**: WebSocket can't send custom headers. Use cookies (same-origin) or pass tokens via `getRealtimeParams`.
...
- [Client Setup](/docs/guides/client-setup) — Client configuration
