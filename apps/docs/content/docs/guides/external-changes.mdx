...
- Familiarity with [Server Setup](/docs/guides/server-setup) and [Table Handlers](/docs/guides/table-handlers)
...
- [Server Setup](/docs/guides/server-setup) -- Configure the sync server
- [Table Handlers](/docs/guides/table-handlers) -- Define sync behavior per table
- [Realtime](/docs/guides/realtime) -- Push updates to clients immediately
