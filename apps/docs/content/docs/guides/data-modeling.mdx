...
- Familiarity with [Scopes](/docs/introduction/scopes) and [Table Handlers](/docs/guides/table-handlers)
...
```ts
{ id: 'project-a', shape: 'tasks', scopes: { project_id: 'proj-a' } }
```
...
The [Testing](/docs/guides/testing) guide shows end-to-end patterns.

## Next steps

- [Scopes](/docs/introduction/scopes) — How scopes work
- [Authorization](/docs/guides/auth) — Implementing `resolveScopes` patterns
