...
```
Client requests { shape: 'tasks', scopes: { project_id: 'A' } }
...
- [Table Handlers](/docs/guides/table-handlers) — Implement handlers
- [Server Setup](/docs/guides/server-setup) — Full server setup
