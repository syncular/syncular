...
- [migration record](../../migration record) — the v2 thesis, the kill/merge gate, and the architecture choices.
- [work record](../../work record) — the road from here to "done."
- [windowing contract](../../windowing contract) — windowed sync / local eviction (implementation plan).
