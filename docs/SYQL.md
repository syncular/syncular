...
- **Status:** Draft, normative upon acceptance of
  [SYQL revision 1](./rfcs/0004-syql-language.md)
...
contract, and conformance requirements. Once SYQL revision 1 is accepted, this
document supersedes descriptive SYQL grammar in `docs/query contract`, the
