...
export async function runOfflineWritesSyncOnReconnect(
  ...
  await syncPullOnce(client2.db, client2.transport, client2.shapes, {
...
export async function runOfflineWithConcurrentChanges(
  ...
  // Bootstrap Client A
  await syncPullOnce(clientA.db, clientA.transport, clientA.shapes, {
  ...
  await syncPullOnce(clientB.db, clientB.transport, clientB.shapes, {
