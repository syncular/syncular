...
queries** designed in from day one (work item 3.1 / `windowing contract` I1–I4).
...
Per `windowing contract` I3, query bindings must be able to route a query's
scope footprint through the window registry once windowed sync (work item §5
