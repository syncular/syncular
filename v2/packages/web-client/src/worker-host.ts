/**
 * Main-thread side of the worker mode (Architecture choice 2): a thin,
 ...
 * follower fanout is post-gate (work item 3.2).
 */
      ...
      return Promise.reject(
        new ClientSyncError(
          ...
          'this tab is not the leader — another tab owns the syncular ' +
            'core for this origin (multi-tab followers are work item 3.2)',
        ),
      );
    }
