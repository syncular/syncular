 ...
 * and the migration record gate self-assessment.
 */
 ...
 *   (2026-07-03, work item 3.1):
 *   the live-query invalidation choke point (`invalidation.ts` + the
 *   apply-path wiring in `client.ts` — the ONE seam implementation contract-eviction I1
...
## Gate self-assessment (migration record "The gate")
