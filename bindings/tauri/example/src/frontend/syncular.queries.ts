...
// irVersion: 1
// irHash: sha256:407235911ace306d91586ae6a379e75b33a06018947902251687762f5c00dff3
...
const listTodosStatements: (QueryRelationPlan & { bind: (params: ListTodosParams) => QueryValue[] })[] = [
  { sql: 'select id, list_id AS "listId", title, done, position, updated_at_ms AS "updatedAtMs", attachment from todos where todos.list_id = ? order by position, id', relations: [{"table":"todos","start":103,"end":108}], bind: (params) => [params.listId] },
];
...
export const listTodosQuery: NamedQuery<ListTodosRow, ListTodosParams> = {
  id: 'sha256:407235911ace306d91586ae6a379e75b33a06018947902251687762f5c00dff3/listTodos',
  hasParams: true,
