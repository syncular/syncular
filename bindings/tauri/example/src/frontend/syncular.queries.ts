...
// irVersion: 1
// irHash: sha256:06213a99bf2a9fbfa7043554751ce38a630aafb3e2b83fd6a8b0e2689310b671
...
const listTodosStatements: (QueryRelationPlan & { bind: (params: ListTodosParams) => QueryValue[] })[] = [
  { sql: 'select id, list_id AS listId, title, done, position, updated_at_ms AS updatedAtMs, attachment from todos where todos.list_id = ? order by position, id', relations: [{"table":"todos","start":99,"end":104}], bind: (params) => [params.listId] },
];
...
export const listTodosQuery: NamedQuery<ListTodosRow, ListTodosParams> = {
  id: 'sha256:06213a99bf2a9fbfa7043554751ce38a630aafb3e2b83fd6a8b0e2689310b671/listTodos',
  hasParams: true,
