...
// irVersion: 1
// irHash: sha256:ab70fac08a04de95b4922c5e1cddc06fd7a51cee15a2c79b17eb474f65e116d7
...
const listTodosStatements: (QueryRelationPlan & { bind: (params: ListTodosParams) => QueryValue[] })[] = [
  { sql: 'select id, list_id AS "listId", title, done, position, updated_at_ms AS "updatedAtMs" from todos where todos.list_id = ? order by position, id', relations: [{"table":"todos","start":91,"end":96}], bind: (params) => [params.listId] },
];
...
export const listTodosQuery: NamedQuery<ListTodosRow, ListTodosParams> = {
  id: 'sha256:ab70fac08a04de95b4922c5e1cddc06fd7a51cee15a2c79b17eb474f65e116d7/listTodos',
  hasParams: true,
