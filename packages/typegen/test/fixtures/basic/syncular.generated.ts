...
export const schema = {
  ...
  tables: [
    ...
    },
    {
      ...
      indexes: [
        { name: 'idx_doc_revisions_doc_id_ref', columns: ['doc_id'], unique: false },
      ],
    },
  ],
} as const;
...
export interface DocRevisionsRow {
  id: string;
  orgId: string;
  projectId: string;
  docId: string | null;
...
/** Insert shape: nullable columns may be omitted. */
export interface DocRevisionsInsert {
  id: string;
  orgId: string;
  projectId: string;
  docId?: string | null;
...
/** Update shape: primary key required, all other columns optional. */
export interface DocRevisionsUpdate {
  id: string;
  orgId?: string;
  projectId?: string;
  docId?: string | null;
...
/** Typed mutation/resource descriptor for 'doc_revisions'. */
export const docRevisionsTable: SyncTable<DocRevisionsRow, DocRevisionsInsert, DocRevisionsUpdate, string> = {
  name: 'doc_revisions',
  primaryKey: 'id',
  physicalPrimaryKey: 'id',
};
