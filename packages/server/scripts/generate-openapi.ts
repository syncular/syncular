...
import { createBlobRoutes } from '../src/hono/blobs';
import { createConsoleRoutes } from '../src/hono/console/routes';
import type { ConsoleAuthResult } from '../src/hono/console/types';
import { createSyncRoutes, type SyncAuthResult } from '../src/hono/routes';
