...
import { createConsoleGatewayRoutes } from '../console/gateway';
import type {
  ConsoleApiKey,
  ConsoleClient,
  ...
  const alphaClients: ConsoleClient[] = [
    {
      ...
      diagnosticFreshnessState: null,
      diagnosticHealthMaxSeverity: null,
      diagnosticReceivedAt: null,
